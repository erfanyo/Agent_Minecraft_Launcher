...
- **权限控制**：只读 / 日常可写（默认，游戏与启动器数据）/ 工作区可写（还包括插件与源码）。
...
**bridge-mod 当前状态**:Fabric 1.21.1 与 Forge 1.20.1、1.19.2、1.18.2 已构建；Forge 1.16.5 已实机验证核心通道；Forge 1.12.2 已编译、待实机联调；1.7.10 尚未完成。详细状态以 `bridge-mod/RELEASE.md` 为准。
