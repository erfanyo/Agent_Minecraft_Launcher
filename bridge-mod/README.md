...
| 1.16.5 / 1.12.2 | Forge | 旧版兼容实现 | 8 | 独立旧工具链已建立、核心双向指令已编译；待逐版本实机联调 |
| 1.7.10 | Forge | 旧版兼容实现 | 8 | 待建立独立工具链 |
...
**构建状态(2026-09)**:✅ Fabric 1.21.1、Forge 1.20.1 / 1.19.2 / 1.18.2、
**Forge 1.16.5 与 Forge 1.12.2** 已编译通过。Forge 1.20.1
